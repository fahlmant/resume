...
\section{EXPERIENCE}
                    ...
                    \sl CTO & Co-founder} \hfill December 2025 - Present\\
                    Axon Data
                    {\sl Principal Site Reliability Engineer} \hfill July 2018 - December 2025\\
                    Red Hat\\
                    Boston, MA\\
                    - Led the cross-company development (Red Hat and Amazon) of AWS managed IAM policies (part of AWS core product offering) for the ROSA HCP service to ensure minimum permission and secure workloads.\\
